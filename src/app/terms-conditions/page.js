	...
	return (
		<div className={styles.container}>
			<div className={styles.hero}>
				...
				<p>
					<strong>Terms of Service for Logiform</strong>
				</p>
				<br/>
				<p className={styles.date}>
					<strong>Last Updated:</strong> August 30th, 2024
				</p>
			</div>
			<div className={styles.content}>
				<div className={styles.section}>
					<h2>Introduction</h2>
					<p>
						Welcome to logiform, (“logiform”, “we”, “our”, or “us”). By accessing or using our website and
						its services, including but not limited to the blog and client portal, you (“you”, “your”, or
						“client”) agree to comply with and be bound by these Terms of Service (“Terms”).
					</p>
				</div>
				...
				<div className={styles.section}>
					...
					<p>
						...
						Company’s stated services, in accordance with and subject to, prevailing law of Delaware. Any
				...
				<div className={styles.section}>
					<h2>Services & Service Terms</h2>
					<p>
						logiform offers a range of marketing services which may be purchased via our client portal or
						website. Details of our services will be provided at the point of sale or as otherwise
						communicated to you.
						<b>
							{' '}
							In the absence of a signed agreement at the point of sale, the following terms of this
							section apply.
						</b>
					</p>
					<ul>
						<li>All payments for marketing services and other are non-refundable.</li>
						<li>
							By using our services, you grant logiform the right to use your name, company logo, and any
							testimonials (published publicly or privately) for purposes including, but not limited to,
							adding to our customer list and showcasing on our website and marketing resources. You may
							opt out of this via written notice to logiform.
						</li>
						<li>
							Some of our services may be set to renew on a daily, weekly, monthly, quarterly,
							semi-annually, or annual basis. Unless otherwise stated in a written agreement between you
							and logiform Inc., services may auto-renew if not canceled with at least 7 days notice prior
							to the renewal date.
						</li>
						<li>
							logiform’s maximum liability shall not exceed 100% of the amounts paid by the client to
							logiform in the preceding 12 months.
						</li>
						<li>
							logiform is providing the Services on a non-exclusive basis. As a result, logiform may
							provide services to any other person or entity, regardless of whether such person or entity
							is a direct competitor of Client.
						</li>
						<li>
							Client agrees that for a period of two (2) years from the end of the Term, without
							logiform’s prior written consent, neither Client nor any of its affiliates, directors,
							managers, officers, representatives or agents shall (a) directly or indirectly induce or
							attempt to induce any employee of logiform to terminate employment with logiform or to
							commence part-time employment with logiform, or in any way interfere with the relationship
							between logiform and any employee thereof; (b) hire any person employed or contracted by
							logiform.
						</li>
					</ul>
				</div>
				...
				<div className={styles.section}>
					<h2>Payment Processing Acknowledgement</h2>
					<p>
						We may use third-party payment processors to process payments made to us. By making a payment,
						you authorize the use of these third-party payment processors and acknowledge that we are not
				...
				<div className={styles.section}>
					<h2>Content</h2>
					<p>
						We reserve the right to post content, including articles, images, and other materials, on our
						blog. This content is provided for informational purposes and we make no representations or
				...
				<div className={styles.section}>
					<h2>Termination</h2>
					<p>
						logiform reserves the right to terminate your access to our services or content at any time,
				...
				<div className={styles.section}>
					...
					<p>
						...
						Delaware. Any disputes arising out of or relating to these Terms or your use of our services
						shall be subject to the exclusive jurisdiction of the courts located in Delaware.
					</p>
					<p>
						By using our website and its services, you acknowledge that you have read, understood, and agree
						to be bound by these Terms of Service. If you do not agree with any of these terms, you are
				...
				<div className={styles.section}>
					<h2>Cookies</h2>
					<p>
						We employ the use of cookies. By accessing logiform.io, you agreed to use cookies in agreement
						with the logiform’s Privacy Policy.
					</p>
					<p>
				...
				<div className={styles.section}>
					<h2>License</h2>
					<p>
						Unless otherwise stated, logiform and/or its licensors own the intellectual property rights for
						all material on logiform.io. All intellectual property rights are reserved. You may access this
						from logiform.io for your own personal use subjected to restrictions set in these terms and
						conditions.
					</p>
					<p>You must not:</p>
					<ul>
						<li>Republish material from logiform.io</li>
						<li>Sell, rent or sub-license material from logiform.io</li>
						<li>Reproduce, duplicate or copy material from logiform.io</li>
						<li>Redistribute content from logiform.io</li>
					</ul>
					<p>This Agreement shall begin on the date hereof.</p>
					<p>
						Parts of this website offer an opportunity for users to post and exchange opinions and
						information in certain areas of the website. Logiform does not filter, edit, publish or review
						Comments prior to their presence on the website. Comments do not reflect the views and opinions
						of Logiform,its agents and/or affiliates. Comments reflect the views and opinions of the person
						who post their views and opinions. To the extent permitted by applicable laws, Logiform shall
					...
					<p>
						Logiform reserves the right to monitor all Comments and to remove any Comments which can be
					...
					<p>
						You hereby grant Logiform a non-exclusive license to use, reproduce, edit and authorize others
				...
				<div className={styles.section}>
					...
					<p>
						...
						hyperlink compensates the absence of Logiform; and (d) the link is in the context of general
					...
					<p>
						...
						our website, you must inform us by sending an e-mail to Logiform. Please include your name, your
					...
					<p>
						No use of Logiform’s logo or other artwork will be allowed for linking absent a trademark
						license agreement.
					</p>
				</div>
				...
				<div className={styles.section}>
					...
					<p>
						...
						check these Terms periodically for changes. By continuing to access or use our services after
						changes become effective, you agree to be bound by the modified Terms.
					</p>
				</div>

				<div className={styles.section}>
					<h2>Contact Us</h2>
					<p>For any questions regarding these Terms, please contact us at legal[at]logiform.io.</p>
				</div>
			</div>
		</div>
	);
