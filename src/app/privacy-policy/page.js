	...
	return (
		<div className={styles.container}>
			<div className={styles.hero}>
				...
				<p className={styles.paragraph}>Last updated: February 09, 2024</p>
			</div>
			<div className={styles.content}>
				<p className={styles.paragraph}>
					This Privacy Policy (“Policy”) applies to https://logiform.io, and LogiForm (“Company”) and governs
					data collection and usage. For the purposes of this Privacy Policy, unless otherwise noted, all
					references to the Company include https://logiform.io. The Company’s website is a marketing services
					site. By using the Company website, you consent to the data practices described in this statement.
				</p>

				<h2 className={styles.subtitle}>Collection of your Personal Information</h2>
				<p className={styles.paragraph}>
				...
				<p className={styles.paragraph}>
					...
					other payment information when ordering and purchasing products and services. To wit, we will use
					your information for, but not limited to, communicating with you in relation to services and/or
					products you have requested from us. We also may gather additional personal or non-personal
					information in the future.
				</p>

				<h2 className={styles.subtitle}>Use of your Personal Information</h2>
				<p className={styles.paragraph}>
				...
				<h2 className={styles.subtitle}>Sharing Information with Third Parties</h2>
				<p className={styles.paragraph}>
				...
				<p className={styles.paragraph}>
					...
					identifiable information (email, name, address, phone number) is transferred to the third party. The
					Company may share data with trusted partners to help perform statistical analysis, send you email or
				...
				<p className={styles.paragraph}>
					The Company may disclose your personal information, without notice, if required to do so by law or
					...
					property of the Company; and/or (c) act under exigent circumstances to protect the personal safety
					of users of the Company, or the public.
				</p>

				<h2 className={styles.subtitle}>Opt-Out of Disclosure of Personal Information to Third Parties</h2>
				<p className={styles.paragraph}>
					In connection with any personal information we may disclose to a third party for a business purpose,
				...
				<p className={styles.paragraph}>
					...
					information. If you exercise your right to opt out of the disclosure of your personal information,
					we will refrain from disclosing your personal information, unless you subsequently provide express
					authorization for the disclosure of your personal information. To opt out of the disclosure of your
					personal information, visit this web page _____.
				</p>

				<h2 className={styles.subtitle}>Tracking User Behavior</h2>
				<p className={styles.paragraph}>
					The Company may keep track of the websites and pages our users visit within the Company, in order to
					determine what the Company services are the most popular. This data is used to deliver customized
					content and advertising within the Company to customers whose behavior indicates that they are
					interested in a particular subject area.
				</p>

				<h2 className={styles.subtitle}>Automatically Collected Information</h2>
				<p className={styles.paragraph}>
					...
					the service, and to provide general statistics regarding the use of the Company’s website.
				</p>

				<h2 className={styles.subtitle}>Use of Cookies</h2>
				<p className={styles.paragraph}>
					The Company’s website may use “cookies” to help you personalize your online experience. A cookie is
				...
				<p className={styles.paragraph}>
					...
					but you can usually modify your browser settings to decline cookies if you prefer. If you choose to
					decline cookies, you may not be able to fully experience the interactive features of the Company’s
				...
				<h2 className={styles.subtitle}>Security of your Personal Information</h2>
				<p className={styles.paragraph}>
				...
				<p className={styles.paragraph}>
					...
					inherent to the Internet that are beyond our control; and (b) the security, integrity, and privacy
					of any and all information and data exchanged between you and us through this site cannot be
					guaranteed.
				</p>

				<h2 className={styles.subtitle}>Right to Deletion</h2>
				<p className={styles.paragraph}>
				...
				<ul className={styles.list}>
					<li>
						Complete the transaction for which the personal information was collected, fulfill the terms of
						a written warranty or product recall conducted in accordance with federal law, and provide a
						good or service requested by you, or reasonably anticipated within the context of our ongoing
				...
				<h2 className={styles.subtitle}>Children Under Thirteen</h2>
				<p className={styles.paragraph}>
					The Company does not knowingly collect personally identifiable information from children under the
					age of 13. If you are under the age of 13, you must ask your parent or guardian for permission to
					use this website.
				</p>

				<h2 className={styles.subtitle}>Opt Out and Unsubscribe from Third-Party Communications</h2>
				<p className={styles.paragraph}>
				...
				<ul className={styles.list}>
					<li>Email: legal@logiform.io</li>
				</ul>

				<h2 className={styles.subtitle}>Email Communications</h2>
				<p className={styles.paragraph}>
					...
					improve our services, we may receive a notification when you open an email from the Company or click
					on a link therein.
				</p>
				<p className={styles.paragraph}>
					If you would like to stop receiving marketing or promotional communications via email from the
					Company, you may opt out of such communications by clicking on the unsubscribe button in an email.
				</p>

				<h2 className={styles.subtitle}>External Data Storage Sites</h2>
				<p className={styles.paragraph}>
					We may store your data on servers provided by third-party hosting vendors with whom we have
					contracted.
				</p>

				<h2 className={styles.subtitle}>Changes to This Statement</h2>
				<p className={styles.paragraph}>
					The Company reserves the right to change this Policy from time to time. For example, when there are
					changes in our services, changes in our data protection practices, or changes in the law. When
					...
					Coinbound, and/or by updating any privacy information. Your continued use of the website and/or
				...
				<h2 className={`${styles.subtitle} ${styles.contact}`}>Contact Information</h2>
				<p className={styles.paragraph}>
