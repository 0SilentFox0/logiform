    ...
    return (
        <>
            <section className={styles.coreTeamSection}>
                ...
                <AnchorLink href='#contact' className={styles.contactButton}>Contact us</AnchorLink>
            </section>

            <section className={styles.valueSection}>
                <div className={styles.valueTitle}>
                    <p>Deep expertise in both Web2 and Web3. Transparency, realistic timelines, and trust are at the core of our process.</p>
                </div>
            </section>
        </>
    );
