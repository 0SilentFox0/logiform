	...
	const methodologies = [
		{
			...
			answer:
				"We leverage our 100+ project experience to ensure we understand the market and your specific needs. We help you find the most efficient and budget-friendly solution.",
		},
		{
	...
	return (
		<section className={styles.methodologySection}>
			<div className={styles.methodologyTitle}>
				...
				<p>
					Tailored Solutions from Needs Assessment to Launch and Ongoing
					Support.
				</p>
			</div>
					...
					{methodologies.map((met, index) => (
						<div
							...
							className={`${styles.methodologyCard} ${
								openMethodology === index ? styles.open : ""
							}`}
