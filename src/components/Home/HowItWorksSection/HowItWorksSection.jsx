					...
					<label htmlFor="c1" className={styles.card}>
						<div className={styles.row}>
							...
							<div className={styles.description}>
								...
								<p>
									Created 100+ project our team understand best industry
									practices and trends. We don’t blindly follow your
									requirements but help you find the most efficient and
