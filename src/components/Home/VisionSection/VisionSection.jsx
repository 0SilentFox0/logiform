			...
			<div className={styles.container}>
				<div className={styles.logos}>
					<div className={styles.logosSlide}>
						<Image src={NimiqLogo} alt="nimiq logo" />
						<Image src={NexoLogo} alt="nexo logo" />
						<Image src={MythicalLogo} alt="mythical logo" />
						<Image src={CoinboundLogo} alt="coinbound logo" />
						<Image src={HalbornLogo} alt="halborn logo" />
						<Image src={EdmundoLogo} alt="edmundo logo" />
						<Image src={DeedyLogo} alt="deedy logo" />
						<Image src={TronLogo} alt="tron logo" />
						<Image src={OKXLogo} alt="okx logo" />
						<Image src={EtoroLogo} alt="etoro logo" />
						<Image src={KionlyLogo} alt="kionly logo" />
					</div>
					<div className={styles.logosSlide}>
						<Image src={NimiqLogo} alt="nimiq logo" />
						<Image src={NexoLogo} alt="nexo logo" />
					...
					<div className={styles.features}>
						<div className={styles.feature}>
							...
							<div className={styles.featureInfo}>
								<h3>Web3 Experts</h3>
								<p>
									A skilled team of blockchain developers, smart contract
									engineers, and UI/UX designers dedicated to Web3.
								</p>
							</div>
						</div>
						<div className={styles.feature}>
						...
						<div className={styles.feature}>
							...
							<div className={styles.featureInfo}>
								...
								<p>
									We’re not just builders; we’re your strategic partners,
									helping you navigate the Web3 landscape and achieve your
									goals.
								</p>
							</div>
						</div>
						<div className={styles.feature}>
							...
							<div className={styles.featureInfo}>
								...
								<p>
									We prioritize the security and integrity of your decentralized
									applications, ensuring robust protection and reliability.
								</p>
							</div>
						</div>
						<div className={styles.feature}>
							...
							<div className={styles.featureInfo}>
								...
								<p>
									We’ve successfully delivered a wide range of Web3 projects,
									from DeFi platforms to NFT marketplaces and beyond.
								</p>
							</div>
						</div>
					</div>
					...
					<div className={styles.teamContainer}>
						<div className={styles.agileTeamSection}>
							...
							<span className={styles.teamImages}>
								<Image src={AVA1} /> <Image src={AVA2} /> <Image src={AVA3} />
							</span>
