				...
				>
						...
						<div className={styles.testimonial}>
							...
							<div className={styles.testimonialInfo}>
								<p className={styles.text}>
									The team delivered an exceptional Web3 educational platform,
									meeting deadlines and maintaining top industry standards. The
									process was seamless, with excellent project management,
									design, code quality, and testing. Highly recommended.
								</p>
					...
					<SwiperSlide className={styles.swiperSlide}>
						<div className={styles.testimonial}>
							...
							<div className={styles.testimonialInfo}>
								<p className={styles.text}>
									I hired LogiForm to assist with developing a new DEX on a
									tight deadline. Despite our time crunch, their shared mindset
									led to a successful launch within a month. We continue to
									collaborate, and I’m grateful for their support.
								</p>
								<div className={styles.authorInfo}>
									<p className={styles.name}>Ben I.</p>
									<p className={styles.company}>NDA project</p>
